...
export function heroScroll(){
    ...
    ScrollReveal().reveal('.project-1', { delay: 300 });
    ScrollReveal().reveal('.project-2', { delay: 600 });
    ScrollReveal().reveal('.project-3', { delay: 900 });
    ScrollReveal().reveal('.project-4', { delay: 1200 });
